...
import FeaturesSectionDemo
    from "@/components/features-section-demo-2";
        ...
        <div
            ...
            <div className="px-4 py-10 md:py-20">
                <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
                    {"Your Swiss Knife For Job Hunting"
                        .split(" ")
                        .map((word, index) => (
                            <motion.span
                                key={index}
                ...
                >
                    Streamline your job search with AI tools
                    for resume building, skills
                    recommendations, application tracking,
                    and networking
                </motion.p>
                <motion.div
                    initial={{
                ...
                >
                    <div
                        ...
                        <div className="flex flex-wrap items-center justify-center text-3xl font-bold">Features</div>
                        <FeaturesSectionDemo/>
                    </div>
                </motion.div>
            </div>
    ...
    return (
        <nav
            ...
            <div className="flex items-center gap-2">
                ...
                <h1 className="text-base font-bold md:text-2xl">Resumate
                    </h1>
            </div>
            <button
